...
Flyer.prototype.act = function(step) {
  this.wobble += step * flyerSpeed;
  var wobblePos = Math.sin(this.wobble) * flyerDist;
  this.pos = this.basePos.plus(new Vector(0, wobblePos));
};
